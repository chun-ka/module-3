...
<div class="row">
    <div class="col" style="background-color: gainsboro;margin-top: 5px;">
        ...
        <form action="/student?action=search" method="post" style="display: inline">
            <input type="text" style="margin-left: 300px" size="10" name="searchName" placeholder="Name">
            <input type="text" size="10" name="searchClassName" placeholder="ClassName">
            <input type="text"  size="10" name="searchAddress" placeholder="Address">
            <button class="btn btn-primary" style="margin-bottom: 10px;">Search</button>
        </form>
    </div>
</div>
<div>
    <button onclick="location.href='/student?action'" type="button" class="btn btn-primary"
